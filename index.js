...
function calculateExpression(expression) {
  ...
  // const a = eval(expression);
  // if (a) {
  //   return a ? `${expression}` : "Argument is not a string";
  // }
}
...
function encodeURLComponent(urlComponent) {
  ...
  const a = encodeURIComponent(urlComponent);
  return a;
}
...
function decodeURLComponent(urlComponent) {
  ...
  const a = decodeURIComponent(urlComponent);
  return a;
}
